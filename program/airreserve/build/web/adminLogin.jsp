       ...
       <%@include file="header.jsp" %>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="background:white">
                <h3 style="color:yellow;background-color:grey;padding:10px">Login Admin</h3>
                <hr/>
                <form role="form"  name="reg_form"  id="form" class="form-horizontal" action="./adminLogin" style="background-color:white; padding:15px" method="POST">
