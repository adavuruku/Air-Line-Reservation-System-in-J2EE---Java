       ...
       <%@include file="userheader.jsp" %>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="background:white">
                ...
                <div class="col-xs-12">
                    <h3 style="color:yellow;background-color:grey;padding:10px">.:. ALL CONFIRMED FLIGHTS .:.</h3>
                    <%
                        int k = 1;
                        @SuppressWarnings("unchecked") 
                        List<blockconfirm> results = (List<blockconfirm>)request.getAttribute("allconfirm");
