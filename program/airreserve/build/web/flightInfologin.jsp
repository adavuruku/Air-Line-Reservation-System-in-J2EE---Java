                ...
                <%
                        ...
                        if (results != null) {%>
                            ...
                            <tbody>   
                                ...
                                <tr>
                                    <td></td>
                                    <%if (Long.valueOf(results.get(19).toString()) < 14){%>
                                        <td></td>
                                    <%}else{%>
                                        <td><a class="btn btn-danger" style="color:yellow;font-weight:bold; text-decoration: none; padding:10px;" href="./confirmblock?bfid=<%=results.get(20)%>&type=block">Block Flight</a></td>
                                    <%}%>
                                    <td><a class="btn btn-success" style="color:yellow;font-weight:bold; text-decoration: none; padding:10px;" href="./confirmblock?bfid=<%=results.get(20)%>&type=confirm">Confirm Flight</a></td>
                                </tr>
                                <tr>
                                    <td COLSPAN="3"></td>
                                </tr>
